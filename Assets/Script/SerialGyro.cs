...
public class SerialGyro : MonoBehaviour {
    ...
    void Update() {
        ...
        if (msg != string.Empty) {
            ...
            yaw_degrees = -yaw * 180.0f / 180.0f; // conversion to degrees
            //if (yaw_degrees < 0) yaw_degrees += 360.0f; // convert negative to positive angles

            pitch_degrees = pitch * 180.0f / 180.0f; // conversion to degrees
            //if (pitch_degrees < 0) pitch_degrees += 360.0f; // convert negative to positive angles

            roll_degrees = -roll * 180.0f / 180.0f; // conversion to degrees
